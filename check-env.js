...
console.log('\n📦 Skills API Configuration (ALWAYS ENABLED):');
console.log('CONTENT_TO_TWEETS_SKILL_ID:', process.env.CONTENT_TO_TWEETS_SKILL_ID ? `✅ ${process.env.CONTENT_TO_TWEETS_SKILL_ID}` : '✅ skill_01SALXgCNgsvghBCYiczfhWW (default)');
